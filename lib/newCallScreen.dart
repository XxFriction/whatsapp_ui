          ...
          children: [
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  addNew("New group call", Icons.people),
                  addNew("New contact", Icons.person_add),
                  Text(
                    "Contacts on WatsApp",
                    style: TextStyle(
                        color: Colors.grey,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Spacer(),
            Icon(Icons.call,color: Color(0xff00af84),), SizedBox(width: 10,),Icon(Icons.videocam,color: Color(0xff00af84),),
          ],
        ),
